...
# Title and Icon
pygame.display.set_caption("Cloudwalk Defender - Pygame")
icon=pygame.image.load('data/cloudwalkt.png')
icon.get_size()
...
# Backgroud
background=pygame.image.load('data/cloudwalkb.jpg')
...
enemy=pygame.image.load('data/ufo.png')
...
# Score
Score_value = 0
font = pygame.font.Font('data/freesansbold.ttf',40)
testX=10
testY=10

def show_score(x,y):
    score=font.render("Cloudwalk enemies destroy: " + str(Score_value), True,(255,215,215))
...
# Sound
pygame.mixer.music.load('data/momentsofclarity.mp3')
